    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-white to-gray-50 py-24 px-6 md:px-16 text-gray-900">
      ...
      <div className="relative max-w-5xl mx-auto text-center">
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
          <button className="px-8 py-3 rounded-full font-semibold bg-blue-600 text-white shadow-md hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300">
            Explore Properties
          </button>

          <button className="px-8 py-3 rounded-full font-semibold border border-gray-300 text-gray-700 hover:border-gray-500 hover:bg-white shadow-sm hover:shadow-md transition-all duration-300">
            Contact Us Today
          </button>
        </div>
